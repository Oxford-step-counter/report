\part{Introduction}
    ...
    \chapter{Motivation}
        ...
        \section{Smartphones and Wearables}
            ...
            Parallel to the increasing adoption of smartphones are the increasing capabilities of such devices. For example, the BLU Diamond M Android Smartphone which is available for \textsterling39.99 on AmazonUK [CIT] has a 1.3 GHz quad-core processor and 512MB RAM [CIT]. This is comparable to flagship devices from earlier years, for example, the Samsung Galaxy S3 released in May 2012 at a cost of \$599 at launch. This device had a 1.4 GHz quad-core processor and 1GB RAM [CIT]. The cost to performance ratio for such devices has decreased dramatically in recent years.
