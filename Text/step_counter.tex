    ...
    \chapter{Data Collection Apparatus}
        ...
        \section{Custom Design}
            ...
            \begin{figure}[!th]
                ...
                \centering
                \caption{A picture of the original data collection device design. Note the push button in the middle of the pink strap. The contact area was reinforced with cardboard in an attempt to increase robustness.}
                \label{img_device_og}
            \end{figure}
            ...
            \begin{figure}[!th]
                ...
                \centering
                \caption{A picture of the original data collection device in use. Notice the placement of the straps on the user's shoes.}
            ...
            The second iteration of the design dropped the push buttons entirely and moved to a method that relied on having a pressure sensitive resistor sit under the heel of the user inside the shoe. 
